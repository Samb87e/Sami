...
const autoPayment = require('./src/autoPayment'); // New command import
...
program
    .command('autopay') // New command definition
    .description('Automatically make payments every millisecond')
    .action(autoPayment);
